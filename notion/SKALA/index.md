...
title: "SKALA 학습 노트"
type: index
tags: [notion, skala, learning]
notion_page_id: local-skala-index
source_url: https://app.notion.com/p/39d1d84bf68e80f389b7e70a6c911bf9
---

# SKALA 학습 노트

> Notion SKALA에서 동기화한 강의·실습 노트의 탐색 허브입니다.
...
- [[notion/SKALA/7-15 Prompt 설계와 Context/7-15 실습 과제 — 시장 분석 프롬프트 개선]]
- [[notion/SKALA/7-15 Prompt 설계와 Context/7-15 추가 사항 — 임원용 1페이지 보고 프롬프트]]
...
## 7/28 — 스마트 데이터 이해 및 활용 Day2

- [[notion/SKALA/7-28 스마트 데이터 이해 및 활용_Day2/7-28 스마트 데이터 이해 및 활용_Day2 핵심 정리]]
- [[notion/SKALA/7-28 스마트 데이터 이해 및 활용_Day2/7-28 스마트 데이터 이해 및 활용_Day2 실습]]
...
## 8/10 — Java, SpringBoot, Rest API 구현 Day1

- [[notion/SKALA/8-10 Java, SpringBoot, Rest API 구현_Day1/8-10 Java, SpringBoot, Rest API 구현_Day1_핵심 정리]]

## 8/11 — Java, SpringBoot, Rest API 구현 Day2

- [[notion/SKALA/8-11 Java, SpringBoot, Rest API 구현_Day2/[8/11] Java, SpringBoot, Rest API 구현_Day2_핵심 정리]]

## 8/12 — Java, SpringBoot, Rest API 구현 Day3

- [[notion/SKALA/8-12 Java, SpringBoot, Rest API 구현_Day3/[8-12] Java, SpringBoot, Rest API 구현_Day3_핵심 정리]]
...
## 8/27 — Agile 방법론 및 MSA 개발 Day2

- [[notion/SKALA/8-27 Agile 방법론 및 MSA 개발_Day2/8-27 Agile 방법론 및 MSA 개발_Day2_실습]]
...
## 8/31 — sLLM 구현 및 Fine Tunning Day2
...
- [[notion/SKALA/9-1 데이터분석 및 AIOps_머신러닝 및 딥러닝 이해_Day1/9-1 데이터분석 및 AIOps_머신러닝 및 딥러닝 이해_B_핵심정리]]
...
- [[notion/SKALA/공모전/2026 K-조선 해커톤 - 2026-08-24 12-00 ~ 2026-09-21 18-00 KST]]

## 공모전

- [[notion/SKALA/공모전/나라장터 자체입찰 공고 법령 위반사항 모니터링 AI 경진대회 - 2026-08-26 10-00 ~ 2026-09-30 10-00 KST]]

## 공모전

- [[notion/SKALA/공모전/2026 ICT·SW 여성 창업공모전 - 2026-08-18 ~ 2026-09-11 18-00 KST]]

## 공모전

- [[notion/SKALA/공모전/월간 해커톤- 마약류 문제 예방과 피해 감소를 위한 아이디어 챌린지 - 2026-08-23 21-00 ~ 2026-09-13 20-59 KST]]

## 공모전

- [[notion/SKALA/공모전/2026 기본사회위원회 정책 아이디어 공모전 - 2026-08-20 ~ 2026-09-23 KST]]
