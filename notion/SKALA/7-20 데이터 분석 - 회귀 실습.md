...
## Day 2 개념과의 연결
이 실습은 [[notion/SKALA/7-20 데이터 분석 개요 및 기초통계_Day2|[7/20] 데이터 분석 개요 및 기초통계_Day2]]에서 다룬 산점도·상관계수·회귀모형·성능 평가·회귀 해석을 실제 데이터 분석 순서로 적용한다.
...
- [[notion/SKALA/7-20 데이터 분석 개요 및 기초통계_Day2|[7/20] 데이터 분석 개요 및 기초통계_Day2]]
