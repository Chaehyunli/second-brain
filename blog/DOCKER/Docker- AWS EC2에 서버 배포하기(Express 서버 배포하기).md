...
- **1. 배포(Deployment)란?** — 배포란, 내가 개발한 웹 서비스 또는 서버를 다른 사용자들이 인터넷을 통해 사용할 수 있도록 만드는 것
- **2. EC2란 무엇인가?** — AWS에서 제공하는 클라우드 컴퓨터를 빌려서 원격으로 사용하는 서비스
- **🛠 3. 실습: EC2로 Express 서버 배포하기** — 한국 사용자 대상 → 아시아 태평양(서울) 선택
