...
- **🐳 1. 왜 Docker를 배워야 할까?** — 서로 다른 환경에서도 똑같은 결과를 보장한다는 것이 Docker의 가장 큰 장점!!
- **🧩 2. Docker의 핵심 개념 세 가지** — 하나의 컴퓨터 안에 여러 개의 독립된 미니 컴퓨터 환경(컨테이너)을 만들 수 있는 툴
- **🌐 3. 보충: IP와 포트 개념** — 한 컴퓨터 내에서 특정 프로그램을 구분하는 주소
