...
![① 라우터별 컨트롤 플레인 (Per-router Control Plane)](assets/네트워크--라우팅-알고리즘---다익스트라/01-라우터별-컨트롤-플레인-Per-router-Control-Plane.webp)

![② SDN 컨트롤 플레인 (Software-Defined Networking)](assets/네트워크--라우팅-알고리즘---다익스트라/02-SDN-컨트롤-플레인-Software-Defined-Networking.webp)

![② SDN 컨트롤 플레인 (Software-Defined Networking)](assets/네트워크--라우팅-알고리즘---다익스트라/03-SDN-컨트롤-플레인-Software-Defined-Networking.webp)
