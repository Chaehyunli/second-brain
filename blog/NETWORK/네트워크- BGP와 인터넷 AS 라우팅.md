...
![🔑 BGP가 각 AS에 제공하는 이중 핵심 기능](assets/네트워크--BGP와-인터넷-AS-라우팅/01-BGP가-각-AS에-제공하는-이중-핵심-기능.webp)

![2. BGP의 기본 동작 및 세션 구성](assets/네트워크--BGP와-인터넷-AS-라우팅/02-2.-BGP의-기본-동작-및-세션-구성.webp)

![4. BGP 경로 광고 및 전파 과정 (eBGP & iBGP)](assets/네트워크--BGP와-인터넷-AS-라우팅/03-4.-BGP-경로-광고-및-전파-과정-eBGP-iBGP.webp)
