...
![1. 버퍼 관리 (Buffer Management):](assets/네트워크--버퍼-관리-스케줄링-및-정책/01-1.-버퍼-관리-Buffer-Management.webp)
...
![주요 알고리즘](assets/네트워크--버퍼-관리-스케줄링-및-정책/02-주요-알고리즘.webp)

![주요 알고리즘](assets/네트워크--버퍼-관리-스케줄링-및-정책/03-주요-알고리즘.webp)
