...
![2) 왜 SDN(소프트웨어 정의 네트워킹)인가? (중앙 집중화의 이점)](assets/네트워크--BGP와-SDN/01-2-왜-SDN-소프트웨어-정의-네트워킹-인가-중앙-집중화의-이점.webp)

![1) SDN의 3대 계층 구조](assets/네트워크--BGP와-SDN/02-1-SDN의-3대-계층-구조.webp)

![2) 컨트롤/데이터 평면 상호작용 시나리오 (링크 단선 발생 예시)](assets/네트워크--BGP와-SDN/03-2-컨트롤-데이터-평면-상호작용-시나리오-링크-단선-발생-예시.webp)
