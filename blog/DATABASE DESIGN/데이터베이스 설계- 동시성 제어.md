...
![락 기반 프로토콜 (Lock-Based Protocols)](assets/데이터베이스-설계--동시성-제어/01-락-기반-프로토콜-Lock-Based-Protocols.webp)

![2단계 락 프로토콜 (Two-Phase Locking Protocol, 2PL)](assets/데이터베이스-설계--동시성-제어/02-2단계-락-프로토콜-Two-Phase-Locking-Protocol-2PL.webp)

![락 구현 (Implementation)](assets/데이터베이스-설계--동시성-제어/03-락-구현-Implementation.webp)
