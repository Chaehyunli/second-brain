...
- **1. 머신러닝의 기본 개념** — 머신러닝(Machine Learning)이란?
- **2. 핵심 용어 정리** — 학습은 모델을 결정하는 변수값(파라미터)을 찾는 과정
- **3. 주요 분류 알고리즘** — Linear Regression (선형 회귀)
- **4. 고차원 데이터와 신경망** — 임의의 데이터는 고차원 공간의 한 점으로 표현 가능
