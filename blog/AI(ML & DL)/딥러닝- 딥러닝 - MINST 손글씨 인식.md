...
![1단계: 데이터 준비하기 - MNIST란 ?](assets/딥러닝--딥러닝---MINST-손글씨-인식/01-1단계-데이터-준비하기---MNIST란.webp)
...
![2단계: 신경망 모델 만들기](assets/딥러닝--딥러닝---MINST-손글씨-인식/02-2단계-신경망-모델-만들기.webp)
...
![3단계: 모델 컴파일하기 (학습 과정 설정)](assets/딥러닝--딥러닝---MINST-손글씨-인식/03-3단계-모델-컴파일하기-학습-과정-설정.webp)
