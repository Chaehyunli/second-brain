...
- **🔄 선형 회귀 모델 구현 단계** — 선형 회귀 모델을 구현하는 과정은 다음의 5단계로 구성됨.
- **1. 문제 정의** — OECD 회원국의 1인당 GDP를 입력으로 받아, 삶의 만족도(Life Satisfaction) 를 예측하는 머신러닝 모델을 구축
- **2. 데이터 수집** — 이번 실습에서는 아래 두 개의 공개 데이터를 사용
