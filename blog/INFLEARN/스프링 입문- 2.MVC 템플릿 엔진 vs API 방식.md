...
![1. MVC와 템플릿 엔진 (Model, View, Controller)](assets/스프링-입문--2.MVC-템플릿-엔진-vs-API-방식/01-1.-MVC와-템플릿-엔진-Model-View-Controller.webp)

![3. API 방식 - 객체 반환 (@ResponseBody + JSON)](assets/스프링-입문--2.MVC-템플릿-엔진-vs-API-방식/02-3.-API-방식---객체-반환-ResponseBody-JSON.webp)
