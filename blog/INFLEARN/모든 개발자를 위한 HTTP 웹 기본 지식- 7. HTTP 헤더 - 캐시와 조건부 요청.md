...
![캐시가 없을 때](assets/모든-개발자를-위한-HTTP-웹-기본-지식--7.-HTTP-헤더---캐시와-조건부-요청/01-캐시가-없을-때.webp)

![캐시가 없을 때](assets/모든-개발자를-위한-HTTP-웹-기본-지식--7.-HTTP-헤더---캐시와-조건부-요청/02-캐시가-없을-때.webp)
...
![캐시가 적용](assets/모든-개발자를-위한-HTTP-웹-기본-지식--7.-HTTP-헤더---캐시와-조건부-요청/03-캐시가-적용.webp)
