...
- **회원 정보 및 기능** — 회원 정보: 이름(username), 나이(age)
- **2. 서블릿으로 회원 관리 웹 애플리케이션 만들기** — 서블릿과 자바 코드만으로 HTML을 생성하는 방식입니다.
- **MemberFormServlet.java (회원 등록 폼)** — 파일명: src/main/java/hello/servlet/web/servlet/MemberFormServlet.java
- **MemberSaveServlet.java (회원 저장)** — 파일명: src/main/java/hello/servlet/web/servlet/MemberSaveServlet.java
