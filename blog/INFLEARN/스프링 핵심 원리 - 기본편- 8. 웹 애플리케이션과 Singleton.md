...
![1. 웹 애플리케이션과 싱글톤](assets/스프링-핵심-원리---기본편--8.-웹-애플리케이션과-Singleton/01-1.-웹-애플리케이션과-싱글톤.webp)

![4. 싱글톤 컨테이너 (Spring)](assets/스프링-핵심-원리---기본편--8.-웹-애플리케이션과-Singleton/02-4.-싱글톤-컨테이너-Spring.webp)
