...
![5. 로그인 처리하기 - 쿠키(Cookie) 사용](assets/스프링-MVC-2편---백엔드-웹-개발-핵심-기술--6.-로그인처리1---쿠키-세션/01-5.-로그인-처리하기---쿠키-Cookie-사용.webp)

![5. 로그인 처리하기 - 쿠키(Cookie) 사용](assets/스프링-MVC-2편---백엔드-웹-개발-핵심-기술--6.-로그인처리1---쿠키-세션/02-5.-로그인-처리하기---쿠키-Cookie-사용.webp)

![5. 로그인 처리하기 - 쿠키(Cookie) 사용](assets/스프링-MVC-2편---백엔드-웹-개발-핵심-기술--6.-로그인처리1---쿠키-세션/03-5.-로그인-처리하기---쿠키-Cookie-사용.webp)
