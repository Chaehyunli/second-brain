...
![예외 변환 전](assets/스프링-DB-2편---데이터-접근-활용-기술--5.-데이터-접근-기술---JPA/01-예외-변환-전.webp)
...
![@Repository 기반 예외 변환 후](assets/스프링-DB-2편---데이터-접근-활용-기술--5.-데이터-접근-기술---JPA/02-Repository-기반-예외-변환-후.webp)
