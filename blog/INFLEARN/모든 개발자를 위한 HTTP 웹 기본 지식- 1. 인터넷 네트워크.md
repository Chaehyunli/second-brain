...
![2. IP (인터넷 프로토콜)](assets/모든-개발자를-위한-HTTP-웹-기본-지식--1.-인터넷-네트워크/01-2.-IP-인터넷-프로토콜.webp)
...
![3. TCP vs UDP (전송 계층)](assets/모든-개발자를-위한-HTTP-웹-기본-지식--1.-인터넷-네트워크/02-3.-TCP-vs-UDP-전송-계층.webp)
...
![4. PORT (프로그램 구분)](assets/모든-개발자를-위한-HTTP-웹-기본-지식--1.-인터넷-네트워크/03-4.-PORT-프로그램-구분.webp)
