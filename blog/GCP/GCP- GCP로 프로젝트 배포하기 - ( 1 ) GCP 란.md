...
- **1. GCP 란?** — GCP는 Google Cloud Platform의 약자로, 구글에서 제공하는 클라우드 컴퓨팅 서비스
- **2. 주요 클라우드 플랫폼의 비교** — 1) GCP (Google Cloud Platform)
- **3. 요약** — GCP는 데이터 분석 및 머신러닝에 강점을 가지고 있으며, 네트워크 성능이 뛰어남
