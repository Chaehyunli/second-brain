...
- **🎓 1. 자바스크립트에서의 클래스** — 문제점: 같은 구조의 객체를 반복해서 만들어야 하므로 코드 중복이 발생
- **🔐 2. 타입스크립트에서의 클래스** — 타입스크립트에서는 클래스 필드와 메서드에 타입 주석을 추가하여 보다 안전한 객체 생성이 가능
- **3. 깃허브 코드 내용** — https://github.com/Chaehyunli/typescript_study/tree/main/section6
