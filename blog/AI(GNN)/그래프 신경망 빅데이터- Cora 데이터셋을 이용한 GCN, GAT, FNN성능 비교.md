...
![원문 이미지 1](assets/그래프-신경망-빅데이터--Cora-데이터셋을-이용한-GCN-GAT-FNN성능-비교/01-원문-이미지.webp)

![원문 이미지 2](assets/그래프-신경망-빅데이터--Cora-데이터셋을-이용한-GCN-GAT-FNN성능-비교/02-원문-이미지.webp)

![원문 이미지 3](assets/그래프-신경망-빅데이터--Cora-데이터셋을-이용한-GCN-GAT-FNN성능-비교/03-원문-이미지.webp)

## 관련 글

- [[blog/AI(GNN)/index|AI(GNN)]]
- [[blog/AI(GNN)/그래프 신경망과 빅데이터- GAE 모델을 활용한 소셜 네트워크 링크 예측 및 이상치 탐지|[그래프 신경망과 빅데이터] GAE 모델을 활용한 소셜 네트워크 링크 예측 및 이상치 탐지]]
