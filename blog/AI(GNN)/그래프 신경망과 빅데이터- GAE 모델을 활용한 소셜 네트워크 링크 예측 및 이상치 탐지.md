...
![2단계: GNN 모델 설계 - 관계를 학습할 두뇌 만들기](assets/그래프-신경망과-빅데이터--GAE-모델을-활용한-소셜-네트워크-링크-예측-및-이상치-탐지/01-2단계-GNN-모델-설계---관계를-학습할-두뇌-만들기.webp)
...
![3단계: 학습 및 평가 - AI를 학습시키기](assets/그래프-신경망과-빅데이터--GAE-모델을-활용한-소셜-네트워크-링크-예측-및-이상치-탐지/02-3단계-학습-및-평가---AI를-학습시키기.webp)

![3단계: 학습 및 평가 - AI를 학습시키기](assets/그래프-신경망과-빅데이터--GAE-모델을-활용한-소셜-네트워크-링크-예측-및-이상치-탐지/03-3단계-학습-및-평가---AI를-학습시키기.webp)
